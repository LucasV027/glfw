...
namespace lgl::debug {
    inline void APIENTRY glDebugOutput(GLenum source, GLenum type, unsigned int id, GLenum severity, GLsizei length,
        ...
        switch (source) {
            ...
            case GL_DEBUG_SOURCE_OTHER: std::cerr << "Source: Other";
                break;
            default:
                std::cerr << "Unknown Source!" << std::endl;
        }
        std::cerr << std::endl;
        ...
        switch (type) {
            ...
            case GL_DEBUG_TYPE_OTHER: std::cerr << "Type: Other";
                break;
            default:
                std::cerr << "Unknown Debug Type: " << type << std::endl;
        }
        std::cerr << std::endl;
        ...
        switch (severity) {
            ...
            case GL_DEBUG_SEVERITY_NOTIFICATION: std::cerr << "Severity: notification";
                break;
            default:
                std::cerr << "Unknown Severity: " << severity << std::endl;
        }
        std::cerr << std::endl;
        std::cerr << std::endl;
    }
